          ...
          <div className="listSearch">
            ...
            <div className="lsItem">
              ...
              <input 
                ...
                value={destination} 
                onChange={(e) => setDestination(e.target.value)}  // Update destination value
                type="text" 
              />
            </div>
            <div className="lsItem">
            ...
            <div className="lsItem">
              ...
              <div className="lsOptions">
                <div className="lsOptionItem">
                  ...
                  <input
                    type="number" onChange={e=>setMin(e.target.value)} className="IsOptionInput" />
                    </div>
                <div className="lsOptionItem">
                  <span className="lsOptionText">
                  ...
                  <input
                    type="number" onChange={e=>setMax(e.target.value)} className="IsOptionInput" />
                </div>
                <div className="lsOptionItem">
